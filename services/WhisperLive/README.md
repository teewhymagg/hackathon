...
(whisperlive) dima@bbb:~/test1/hackathon_bot/hackathon_bot/WhisperLive_fresh$ export LD_LIBRARY_PATH=$CONDA_PREFIX/lib/python3.10/site-packages/nvidia/cudnn/lib:$LD_LIBRARY_PATH
(whisperlive) dima@bbb:~/test1/hackathon_bot/hackathon_bot/WhisperLive_fresh$ python3 run_server.py --port 9090 --backend faster_whisper -m
```
