...
app = FastAPI(title="hackathon_bot Bot Manager")
...
async def root():
    return {"message": "hackathon_bot Bot Manager is running"}
...
# --- ADDED: Endpoint for hackathon_bot-Bot to report its exit status ---
@app.post("/bots/internal/callback/exited",
          status_code=status.HTTP_200_OK,
          summary="Callback for hackathon_bot to report its exit status",
...
# --- ADDED: Endpoint for hackathon_bot-Bot to report its startup status ---
@app.post("/bots/internal/callback/started",
          status_code=status.HTTP_200_OK,
          summary="Callback for hackathon_bot to report its startup status",
          include_in_schema=False) # Hidden from public API docs
...
# --- ADDED: Endpoint for hackathon_bot-Bot to report joining status ---
@app.post("/bots/internal/callback/joining",
          status_code=status.HTTP_200_OK,
          summary="Callback for hackathon_bot to report joining status",
          include_in_schema=False) # Hidden from public API docs
...
# --- ADDED: Endpoint for hackathon_bot-Bot to report awaiting admission status ---
@app.post("/bots/internal/callback/awaiting_admission",
          status_code=status.HTTP_200_OK,
          summary="Callback for hackathon_bot to report awaiting admission status",
          include_in_schema=False) # Hidden from public API docs
